...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/11/2024 às 23:43
...
(2, 3, 6, '2024-11-30 10:10:00', 'Old School, New School, Realismo, Aquarela, Tribal, Dotwork', 'pendente'),
(3, 2, 4, '2024-11-30 00:04:00', 'New School, Realismo', ''),
(4, 2, 4, '2024-11-30 00:04:00', 'New School, Realismo', '');
...
(2, 'teste01', 'teste01@teste01.com.br', '$2y$10$3h7/zh91olE0iTpeLd0elOd5g.k7NHaZxL6mrtwZkjHNnEv4LgLJi', '(48) 98840-8811', '1998-06-10', 'foto_2.jpg', 'blackwork', 'tatuador01', 1, 'cliente', '2024-11-10 02:58:43'),
(3, 'teste002', 'teste002@teste.com.br', '$2y$10$Fxa2HDw6qcaF18r1796RRuKUw2B2o1QAYKIHqW7nFnbFRvuTPA3Gi', '48999999', '1998-06-10', 'foto_3.png', NULL, NULL, 0, 'cliente', '2024-11-30 02:09:09');
...
--
-- Estrutura para tabela `portfolio_tatuador`
--

CREATE TABLE `portfolio_tatuador` (
  `id` int(11) NOT NULL,
  `id_tatuador` int(11) NOT NULL,
...
--
-- Despejando dados para a tabela `portfolio_tatuador`
--

INSERT INTO `portfolio_tatuador` (`id`, `id_tatuador`, `imagem`, `descricao`, `data_upload`) VALUES
(1, 5, 'uploads/portfolio/painlogo.jpg', 'Blackwork', '2024-11-30 01:30:39'),
(2, 5, 'uploads/portfolio/painlogo.jpg', 'Blackwork', '2024-11-30 01:42:44'),
(3, 5, 'uploads/portfolio/painlogo.jpg', 'Blackwork', '2024-11-30 01:42:45'),
(4, 5, 'uploads/portfolio/painlogo.jpg', 'Blackwork', '2024-11-30 01:42:46'),
(5, 4, 'uploads/portfolio/download.png', 'teste', '2024-11-30 02:17:24');
...
(5, 'teste001', 'teste001@teste.com', '$2y$10$Vb5loXaK.2tbSMAfudPDHuklQt9WQaOov2tpdfJtXArxXULHf0wu2', NULL, NULL, NULL, NULL, '2024-11-30 01:29:47', NULL),
(6, 'tatuador001', 'tatuador001@teste.com.br', '$2y$10$BVqAqupV4vAm2H74pkS45O6ZUfxz3mWAfDhX3j9J1yirgGKSuntzm', NULL, NULL, NULL, NULL, '2024-11-30 02:00:39', NULL);
...
--
-- Índices de tabela `portfolio_tatuador`
--
ALTER TABLE `portfolio_tatuador`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_tatuador` (`id_tatuador`);
...
--
-- AUTO_INCREMENT de tabela `portfolio_tatuador`
--
ALTER TABLE `portfolio_tatuador`
...
--
-- Restrições para tabelas `portfolio_tatuador`
--
ALTER TABLE `portfolio_tatuador`
  ADD CONSTRAINT `portfolio_tatuador_ibfk_1` FOREIGN KEY (`id_tatuador`) REFERENCES `tatuadores` (`id`) ON DELETE CASCADE;
COMMIT;
